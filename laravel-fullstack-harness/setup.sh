...
echo ""
echo "============================================"
echo "  laravel-fullstack-harness 安装"
echo "============================================"
echo ""
...
CLAUDE_SKILL_DIR="${HOME}/.claude/skills/laravel-fullstack-harness"
mkdir -p "${CLAUDE_SKILL_DIR}"
cp "${SCRIPT_DIR}/SKILL.md" "${CLAUDE_SKILL_DIR}/SKILL.md"
echo "  ✓ ${CLAUDE_SKILL_DIR}/SKILL.md"

CODEX_HOME="${CODEX_HOME:-${HOME}/.codex}"
CODEX_SKILL_DIR="${CODEX_HOME}/skills/laravel-fullstack-harness"
mkdir -p "${CODEX_SKILL_DIR}"
cat > "${CODEX_SKILL_DIR}/SKILL.md" << 'CODEX_SKILL_EOF'
---
name: laravel-fullstack-harness
description: Laravel + Vue 全栈 Harness Engineering skill。后端在 backend/，前端在 frontend/，覆盖 Laravel API、Eloquent、Queue、Scheduler、Event、Notification，以及 Vue 3 + Vite + TypeScript。所有该类项目任务都应触发。
---
...
echo ""
echo "  全局 Skill："
echo "    ~/.claude/skills/laravel-fullstack-harness/SKILL.md"
echo "    ~/.codex/skills/laravel-fullstack-harness/SKILL.md"
echo ""
echo "  项目文件："
echo "    ${PROJECT_DIR}/"
echo "    ├── CLAUDE.md"
...
echo "            ├── frontend-architecture.md"
echo "            ├── frontend-api.md"
echo "            ├── frontend-coding.md"
