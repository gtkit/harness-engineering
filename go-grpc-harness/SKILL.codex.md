...
description: Go gRPC 微服务 Harness Engineering skill。用于已安装 go-grpc-harness 的项目（grpc-go + buf + protovalidate）；触发后读取项目根目录 AGENTS.md 和 .harness/guides/。
---
...
2. 再按任务类型读取 `.harness/guides/` 中对应文档（gRPC/proto/buf 任务读 `grpc-conventions.md`）
