---
name: go-grpc-harness
description: Go gRPC 微服务 Harness Engineering skill。用于已安装 go-grpc-harness 的项目（grpc-go + buf + protovalidate）；触发后读取项目根目录 CLAUDE.md 和 .harness/guides/。
---

# Go gRPC Harness Skill
...
3. 再按任务类型读取 `.harness/guides/` 中对应文档（gRPC/proto/buf 任务读 `grpc-conventions.md`）
