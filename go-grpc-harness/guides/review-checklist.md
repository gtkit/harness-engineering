...
> BASE: go-harness/guides/review-checklist.md @ 2026-07-03（通用规则同源;通用改进先落 go-grpc-harness,择机回灌 go-harness）
...
- [ ] application 没有 import GORM / repository / 渠道 SDK / gobreaker
- [ ] transport/http 没有 import GORM / repository
- [ ] repository 没有 import module / transport 协议包
- [ ] worker 没有直接 import GORM / repository
- [ ] internal/pkg 没有反向依赖 module
- [ ] application / models 没有 import 基础设施型 paginator;pb/ 产物没有手改
