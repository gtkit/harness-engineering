...
assert_file_exists "${ROOT_DIR}/shared/guides/laravel/architecture.md"
assert_file_exists "${ROOT_DIR}/shared/guides/laravel/http-and-api.md"
assert_file_exists "${ROOT_DIR}/shared/guides/laravel/data-and-eloquent.md"
assert_file_exists "${ROOT_DIR}/shared/guides/laravel/queues-events-scheduling.md"
assert_file_exists "${ROOT_DIR}/shared/guides/laravel/notifications-and-mail.md"
assert_file_exists "${ROOT_DIR}/shared/guides/laravel/testing-and-validation.md"
assert_file_exists "${ROOT_DIR}/shared/guides/laravel/laravel-modules.md"
...
assert_file_contains "${ROOT_DIR}/shared/guides/laravel/laravel-modules.md" "Modules/"
...
assert_file_contains "${readme_file}" '$harness-research'
assert_file_contains "${readme_file}" "docs/harness-command-workflow.md"
assert_file_contains "${readme_file}" "skills/harness-"
...
assert_file_exists "${laravel_project}/.claude/skills/harness-doctor/SKILL.md"
assert_file_contains "${laravel_project}/.claude/skills/harness-doctor/SKILL.md" "Harness Doctor"
...
assert_file_exists "${laravel_fullstack_project}/.claude/skills/harness-doctor/SKILL.md"
assert_file_contains "${laravel_fullstack_project}/.claude/skills/harness-doctor/SKILL.md" "Harness Doctor"
